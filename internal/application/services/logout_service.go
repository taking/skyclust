...
func (ls *LogoutService) Logout(userID uuid.UUID, token string) error {
...
func (ls *LogoutService) LogoutWithContext(ctx context.Context, req LogoutRequest) (*LogoutResponse, error) {
	switch req.AuthType {
	case "jwt":
