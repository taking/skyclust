...
// UpdateNodeGroup handles updating a node group (not used for GCP, but required by interface)
func (h *GCPHandler) UpdateNodeGroup(c *gin.Context) {
...
func (h *GCPHandler) GetEKSAmitTypes(c *gin.Context) {
