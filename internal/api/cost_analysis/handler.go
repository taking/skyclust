...
func (h *Handler) GetCostSummary(c *gin.Context) {
	...
	if workspaceID == "" {
		common.BadRequest(c, "Workspace ID is required")
		return
	}
	...
	common.OK(c, summary, "Cost summary retrieved successfully")
}
...
func (h *Handler) GetCostPredictions(c *gin.Context) {
	...
	common.OK(c, predictions, "Cost predictions retrieved successfully")
}
...
func (h *Handler) GetCostTrend(c *gin.Context) {
	...
	common.OK(c, trend, "Cost trend retrieved successfully")
}
...
func (h *Handler) GetCostBreakdown(c *gin.Context) {
	...
	common.OK(c, breakdown, "Cost breakdown retrieved successfully")
}
...
func (h *Handler) GetCostComparison(c *gin.Context) {
	...
	common.OK(c, comparison, "Cost comparison retrieved successfully")
}
