...
func (tdb *TestDatabase) SetupTestData() error {
	// Create test users
	users := []domain.User{
		{ID: uuid.MustParse("user1"), Username: "testuser1", Email: "test1@example.com", IsActive: true},
		{ID: uuid.MustParse("user2"), Username: "testuser2", Email: "test2@example.com", IsActive: true},
	}
	...
	workspaces := []domain.Workspace{
		{ID: "workspace1", Name: "Test Workspace 1", OwnerID: "user1", IsActive: true},
		{ID: "workspace2", Name: "Test Workspace 2", OwnerID: "user2", IsActive: true},
	}
