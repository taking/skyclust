...
import { getApiUrl, getApiVersion } from './config';
import { BaseErrorHandler, ErrorHandler } from '../error-handling';
  ...
  protected async request<T>(
    ...
    try {
      ...
      if (error instanceof ServiceError) {
        ...
        BaseErrorHandler.logError(error, { method, url, service: this.constructor.name });
        throw error;
      }
