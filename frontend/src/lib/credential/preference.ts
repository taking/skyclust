...
export function trackCredentialUsage(
  ...
  try {
    ...
    log.warn('Failed to track credential usage', error, { workspaceId, credentialId, provider, resourceType });
  }
}
...
export function setDefaultCredential(
  ...
  try {
    ...
    log.warn('Failed to set default credential', error, { workspaceId, provider, credentialId });
  }
}
...
export function getDefaultCredential(
  ...
  try {
    ...
    log.warn('Failed to get default credential', error, { workspaceId, provider });
    return null;
  }
}
...
export function getRecentlyUsedCredentials(
  ...
  try {
    ...
    log.warn('Failed to get recently used credentials', error, { workspaceId, provider, limit });
    return [];
  }
}
...
function loadPreferences(workspaceId: string): CredentialPreference {
  try {
    ...
    log.warn('Failed to load credential preferences', error, { workspaceId });
  }
...
function savePreferences(workspaceId: string, preferences: CredentialPreference): void {
  try {
    ...
    log.warn('Failed to save credential preferences', error, { workspaceId });
  }
}
...
export function clearPreferences(workspaceId: string): void {
  try {
    ...
    log.warn('Failed to clear credential preferences', error, { workspaceId });
  }
}
