    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="http://localhost:9000/organizations/sentry/issues/?project=2">Issues Page</a>.
