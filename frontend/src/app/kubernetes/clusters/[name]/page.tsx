 ...
 * /kubernetes/clusters/{name} -> /{workspaceId}/{credentialId}/kubernetes/clusters/{name}
 */
...
export default function KubernetesClusterDetailRedirectPage() {
  ...
  useEffect(() => {
    if (currentWorkspace?.id && selectedCredentialId && clusterName) {
  ...
  }, [currentWorkspace, selectedCredentialId, clusterName, router, searchParams, selectedRegion]);
