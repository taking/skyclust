...
export default function KubernetesClusterDetailPage() {
  ...
  const handleCreateNodePool = (data: any) => {
  ...
  const handleCreateNodeGroup = (data: any) => {
  ...
  const handleFormValueChange = (field: 'credential_id' | 'region', value: string) => {
    // This is handled by the form components themselves
  };
